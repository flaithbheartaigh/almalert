...
class CLocaleControl;
class CLocaleView: public CAknView
{
  public:
    static CLocaleView* NewLC(void);
    ~CLocaleView();
  private:
  ...
  private:
    CLocaleControl* iControl;
};

class CLocaleControl: public CAknSettingItemList
{
  public:
    static CLocaleControl* NewL(const TRect& aRect);
    ~CLocaleControl();
