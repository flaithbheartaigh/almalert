...
TInt TTickInt::TickComplete(TAny* aPtr) //FIXME: NOT IMPLEMENTED
{
  return KErrNone;
}

void TTickInt::Service(void) //FIXME: NOT IMPLEMENTED
{
}

void TTickInt::InvalidateTickCounter(void) //FIXME: NOT IMPLEMENTED
{
}
