...
EXPORT_C TInt DPhysicalDevice::Remove()
{
  return KErrNone;
}
...
EXPORT_C TBool DPhysicalDevice::IsAvailable(TInt aUnit,const TDesC *anInfo) const
{
  return ETrue;
}

EXPORT_C TUint DPhysicalDevice::CheckForSlowOpening(TInt aUnit)
{
  return 0;
}
